...
if ( ! class_exists( 'weblog_author_widget' ) ) :
    ...
    class weblog_author_widget extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'weblog_author_title' ) ); ?>"><?php _e( 'Title:', 'weblog' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'weblog_author_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'weblog_author_title' ) ); ?>" type="text" value="<?php echo esc_attr( $weblog_author_title ); ?>" />
            </p>
            <h4><?php _e( 'Author Image', 'weblog' ); ?></h4>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'weblog_author_image' ) ); ?>">
                ...
                <input type="text" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'weblog_author_image' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'weblog_author_image' ) ); ?>" value="<?php echo esc_url( $weblog_author_image ); ?>" />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'weblog_author_short_disc' ) ); ?>"><?php _e( 'Author Short Disc:', 'weblog' ); ?></label>
                <textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'weblog_author_short_disc' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'weblog_author_short_disc' ) ); ?>"><?php echo esc_html( $weblog_author_short_disc ); ?></textarea>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'weblog_author_link' ) ); ?>"><?php _e( 'Link URL:', 'weblog' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'weblog_author_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'weblog_author_link' ) ); ?>" type="text" value="<?php echo esc_attr( $weblog_author_link ); ?>" />
            </p>
            <p>
                <input id="<?php echo esc_attr( $this->get_field_id( 'weblog_author_new_window' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'weblog_author_new_window' ) ); ?>" type="checkbox" <?php checked( 1 == $weblog_author_new_window ? $instance['weblog_author_new_window'] : 0); ?> />
                <label for="<?php echo esc_attr( $this->get_field_id( 'weblog_author_new_window' ) ); ?>"><?php _e( 'Open in new window', 'weblog' ); ?></label>
            </p>
            <hr />
            <?php
        }
        ...
        function update( $new_instance, $old_instance ) {
            ...
            $instance['weblog_author_image'] = ( isset( $new_instance['weblog_author_image'] ) ) ?  esc_url_raw( $new_instance['weblog_author_image'] ): '';
            $instance['weblog_author_link'] = ( isset( $new_instance['weblog_author_link'] ) ) ?  esc_url_raw( $new_instance['weblog_author_link'] ): '';
