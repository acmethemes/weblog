...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.at-gsm-btn' ).click( function ( e ) {
		...
		$( this ).text( weblog_adi_install.btn_text );
		...
		$.ajax({
			...
			data: {
				...
				security : weblog_adi_install.nonce,
		...
		$.ajax({
			...
			success:function( response ) {
                var extra_uri, redirect_uri, dismiss_nonce;
							redirect_uri         = weblog_adi_install.adminurl+'/themes.php?page=advanced-import&browse=all&at-gsm-hide-notice=welcome';
