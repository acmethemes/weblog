...
if ( ! function_exists( 'weblog_skip_to_content' ) ) :
	...
	function weblog_skip_to_content() {
		...
		?>
		<a class="skip-link screen-reader-text" href="#<?php echo esc_attr( $weblog_content_id ); ?>" title="link"><?php esc_html_e( 'Skip to content', 'weblog' ); ?></a>
		<?php
	}
endif;
		...
		<header id="masthead" class="site-header" role="banner">
			<div class="header-wrapper clearfix">
				<div class="header-container">
					...
					?>
					<nav id="site-navigation" class="main-navigation <?php echo esc_attr( $weblog_enable_sticky_menu ); ?> clearfix" role="navigation">
						<div class="wrapper">
...
if ( ! function_exists( 'weblog_before_content' ) ) :
	...
	<div id="<?php echo esc_attr( $weblog_content_id ); ?>" class="site-content">
		...
		$sidebar_layout = weblog_sidebar_selection( get_the_ID() );
