...
if ( ! class_exists( 'Weblog_Theme_Info' ) ) {
	class Weblog_Theme_Info {
		...
		public function get_config() {
			...
			return array(
				...
				'recommended_actions' => array(
					'demo-content' => array(
						'title'       => esc_html__( 'Install Gutentor', 'weblog' ),
						'desc'        => sprintf( esc_html__( 'Customize everything within default WordPress editor %1$s Gutentor : WordPress Page Builder with Unlimited Possibilities to Design %2$s.', 'weblog' ), '<a target="_blank" href="https://www.gutentor.com/" >', '</a>' ),
						'id'          => 'gutentor',
			...
			if (
				...
				if ( ! $notice_nag ) {
					echo '<div class="at-gsm-notice">
                        <small class="plugin-install-notice">' . esc_html__( 'Clicking the button below will install and activate the Advanced Import plugin.', 'weblog' ) . '</small>
                        <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="' . esc_html__( 'Get started with Weblog', 'weblog' ) . '">
                         ' . esc_html__( 'Get started with Weblog', 'weblog' ) . '                   
                         </a>
                    </div>';
				}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'weblog-theme-info-css', get_template_directory_uri() . '/acmethemes/at-theme-info/css/at-theme-info.css' );
