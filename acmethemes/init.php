...
require_once weblog_file_directory('acmethemes/functions/sidebar-selection.php');
...
require_once weblog_file_directory('acmethemes/gutenberg/gutenberg-init.php');
...
add_action('init', function() {
    ...
    require_once weblog_file_directory('acmethemes/admin-notice/class-admin-notice-handler.php');
}